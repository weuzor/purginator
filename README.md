...
!([happily_together.png](https://github.com/weuzor/purginator/blob/main/happily_together.png))
...
### Brushinator (a gantry mounted brush holder matching the purginator design) 
